...
public class MainActivity extends AppCompatActivity {
    String Storage_Path = "autoparts_img/";
    ...
    */
    public void uploadFile() {
        ...
        if (filePath != null) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            sRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri downloadPhotoUrl) {
                                    Model food = new Model(edName.getText().toString().trim(),
            ...
            android.widget.Toast.makeText(MainActivity.this, "Please Select Image or Add Image Name", android.widget.Toast.LENGTH_LONG).show();
        }
    }
